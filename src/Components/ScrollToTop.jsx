...
function SimpleExperienceSection() {
      ...
      <section className="py-24 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <p className="text-gray-400 uppercase tracking-widest mb-2">MY JOURNEY</p>
            <h2 className="text-5xl sm:text-6xl md:text-7xl font-bold text-white">Experience</h2>
          </div>
              ...
              >
                <div className="flex flex-col md:flex-row gap-6 md:gap-10 items-start">
                  <div className="flex flex-col items-start gap-1 md:w-1/4">
                    <span className="text-4xl font-bold text-white/20">{experience.id.toString().padStart(2, "0")}</span>
                  ...
                  <div className="flex flex-col gap-4 md:w-3/4">
                    ...
                    <div className="flex items-center space-x-1 mt-4">
                      <div className="w-12 h-1.5 bg-[#1c332b] rounded-full"></div>
                      <div className="w-8 h-1.5 bg-[#1c332b] rounded-full"></div>
                      <div className="w-4 h-1.5 bg-[#1c332b] rounded-full"></div>
                    </div>
                  </div>
                </div>
              </div>
  ...
  export default SimpleExperienceSection
